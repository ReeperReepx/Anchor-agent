    ...
    <div className="min-h-screen bg-[#F5F5F7]">
      ...
      <aside className="hidden sm:flex fixed top-0 left-0 bottom-0 w-[220px] flex-col border-r border-[#E5E5E5] bg-gradient-to-b from-white via-white to-[#F5F5F7] z-50">
        <div className="px-5 h-16 flex items-center">
          <Link
            href="/dashboard"
            className="flex items-center gap-2 font-bold text-[#0071E3] text-lg"
          >
            ...
            return (
              <Link
                ...
                className={`flex items-center gap-3 px-3 py-2.5 rounded-[10px] text-[13px] font-medium transition-colors relative ${
                  isActive
                    ? "bg-[rgba(0,113,227,0.06)] text-[#1D1D1F]"
              ...
              >
                ...
                <span className={isActive ? "text-[#0071E3]" : ""}>{item.icon}</span>
                {item.label}
              </Link>
            );
          })}
        ...
        <div className="px-3 pb-4 space-y-3">
          ...
          <div className="flex items-center gap-2.5 px-2">
            <div className="w-8 h-8 rounded-full bg-[rgba(0,113,227,0.15)] flex items-center justify-center text-[#0071E3] text-[13px] font-semibold shrink-0">
              {initials}
            </div>
          ...
          <Link href="/standup" className="block">
            <button className="w-full flex items-center justify-center gap-2 bg-[#0071E3] hover:bg-[#0077ED] text-white px-4 py-2.5 rounded-[10px] text-sm font-semibold transition-all shadow-[0_2px_12px_rgba(0,113,227,0.3)] hover:shadow-[0_4px_16px_rgba(0,113,227,0.4)] hover:-translate-y-[1px] active:translate-y-0 active:scale-[0.97]">
      ...
      <nav className="sm:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-[#E5E5E5] z-50">
        <div className="flex items-center justify-around h-16 px-2">
          ...
          {MOBILE_LEFT.map((item) => {
            ...
            return (
              <Link
                ...
                className={`flex flex-col items-center gap-1 min-w-[48px] min-h-[48px] justify-center rounded-lg transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0071E3] ${
          ...
          <Link
            ...
            className="flex items-center justify-center w-[52px] h-[52px] -mt-6 rounded-full bg-[#0071E3] text-white shadow-[0_4px_20px_rgba(0,113,227,0.35)] active:scale-95 transition-transform focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0071E3] focus-visible:ring-offset-2"
          >
