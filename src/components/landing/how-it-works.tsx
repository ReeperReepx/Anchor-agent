    ...
    <section id="how-it-works" className="px-5 sm:px-10 py-16 sm:py-24 bg-[#000000]">
          ...
          <div className="p-5 sm:p-8 grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-6">
            ...
            <div className="bg-[#f5f5f7] rounded-xl p-4 border border-[#e5e5e5]/80">
              ...
              <div className="space-y-2.5">
                ...
                <div className="bg-[#FF9500] rounded-lg rounded-br-sm px-3 py-2 text-[12px] text-white max-w-[85%] ml-auto">
              ...
              <div className="flex items-center gap-2 mt-4 pt-3 border-t border-[#e5e5e5]">
                <div className="w-5 h-5 rounded-full bg-[#FF9500]/10 flex items-center justify-center">
                  <svg width="8" height="8" viewBox="0 0 24 24" fill="none" stroke="#FF9500" strokeWidth="2.5">
                    <path d="M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 6 0V4a3 3 0 0 0-3-3z" />
                    <path d="M19 10v2a7 7 0 0 1-14 0v-2" />
                  </svg>
                </div>
                <div className="flex items-center gap-[2px] flex-1">
                  {[3,5,8,11,14,16,17,16,14,11,8,5,3].map((h, i) => (
                    <div key={i} className="w-[2px] rounded-full bg-[#FF9500]" style={{ height: `${h}px`, opacity: 0.4 + (h / 30) }} />
                  ))}
                </div>
            ...
            <div className="bg-[#f5f5f7] rounded-xl p-4 border border-[#e5e5e5]/80">
              <div className="flex items-center gap-2 mb-4">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#FF9500" strokeWidth="1.5">
              ...
              <div className="space-y-3">
                <div>
                  <div className="text-[10px] font-bold text-[#FF9500] uppercase tracking-wider mb-1">Yesterday</div>
      ...
      <ScrollReveal>
        <div className="text-center mt-8 sm:mt-10">
          <Link
            href="/login"
            className="inline-flex items-center justify-center bg-[#FF9500] hover:bg-[#FFa526] text-white px-8 py-3 rounded-full text-[14px] font-semibold transition-colors min-h-[48px]"
          >
            Start free trial
          </Link>
        </div>
