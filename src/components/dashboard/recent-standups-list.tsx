      ...
      <CardContent>
        {standups.length === 0 ? (
          <div className="py-10 text-center">
            ...
            <a href="/standup" className="inline-flex items-center gap-2 bg-[#0071E3] hover:bg-[#0077ED] text-white px-5 py-2.5 rounded-xl text-sm font-semibold transition-all shadow-[0_2px_12px_rgba(0,113,227,0.3)]">
            ...
            {standups.map((standup) => (
              <div
                ...
                className={`flex items-start justify-between border-l-2 pl-4 pb-4 last:pb-0 ${
                  standup.type === "weekly" ? "border-l-[#FBBF24]" : "border-l-[#0071E3]"
                }`}
              >
