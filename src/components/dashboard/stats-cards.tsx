...
export function StatsCards({
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
      <Card className="!bg-gradient-to-br !from-[rgba(0,113,227,0.07)] !to-[rgba(0,113,227,0.02)] !border-[rgba(0,113,227,0.2)] !shadow-[0_2px_16px_rgba(0,113,227,0.08)] relative overflow-hidden">
        <div className="absolute top-0 right-0 w-20 h-20 bg-[rgba(0,113,227,0.06)] rounded-full -translate-y-1/2 translate-x-1/2" />
        <CardHeader>
          <CardTitle className="text-[11px] font-semibold text-[#0071E3] uppercase tracking-[1px]">Current Streak</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="flex items-baseline gap-2">
            <div className="text-2xl sm:text-3xl font-bold text-[#0071E3]">{streak?.current_streak ?? 0}</div>
