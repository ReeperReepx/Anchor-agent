...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-[#F8F7F4]">
      <nav className="sticky top-0 z-50 bg-[#F8F7F4]/80 backdrop-blur-lg flex items-center justify-between px-10 py-4 max-w-[1100px] mx-auto border-b border-[#E5E5E5]/60">
