    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center bg-[#F8F7F4] px-6">
        <div className="w-full max-w-[380px]">
          ...
          <div className="bg-white rounded-[16px] border border-[#E5E5E5] shadow-[0_4px_24px_rgba(0,0,0,0.06)] p-8">
            {sent ? (
              ...
              <>
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-3 border border-[#E5E5E5] hover:border-[#D0D0D0] bg-white hover:bg-[#FAFAFA] rounded-[10px] px-4 py-2.5 text-sm font-medium text-[#1D1D1F] transition-all hover:-translate-y-[0.5px] active:translate-y-0"
                >
                ...
                <form onSubmit={handleMagicLink}>
                  ...
                  <input
                    ...
                    className="w-full rounded-[10px] border border-[#E5E5E5] bg-[#FAFAFA] px-3.5 py-2.5 text-sm text-[#1D1D1F] placeholder-[#9CA3AF] focus:outline-none focus:ring-2 focus:ring-[#B85C42]/30 focus:border-[#B85C42] transition-all"
                  />
                  {error && (
